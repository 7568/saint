...
Description: 使用1x1大小的卷积核来对数据进行卷积操作，从而进行特征提取
"""
...
def conv1x3(in_planes: int, out_planes: int, stride: int = 1, groups: int = 1, dilation: int = 1) -> nn.Conv2d:
    ...
    return nn.Conv2d(in_planes, out_planes, kernel_size=(3, 1), padding=(1, 0), stride=stride,
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(5, self.inplanes, kernel_size=1, stride=1, padding=0,
                               bias=False)
