...
def catb_model(x_train, y_train, x_vaidation, y_validation, x_test, cat_idxs):
    """XGBoost.
...
if __name__ == '__main__':
    ...
    if continuous_mean_std is not None:
        ...
        X_TRAIN['data'] = np.concatenate((X_TRAIN_X2, X_TRAIN_X1), axis=1, dtype=object)
        X_VALID['data'] = np.concatenate((X_VALID_X2, X_VALID_X1), axis=1, dtype=object)
        X_TEST['data'] = np.concatenate((X_TEST_X2, X_TEST_X1), axis=1, dtype=object)

    y_test_hat = catb_model(X_TRAIN['data'], Y_TRAIN['data'], X_VALID['data'], Y_VALID['data'], X_TEST['data'],
                            cat_idxs)
